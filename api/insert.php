<?php
	...
	if ( isset( $_GET['id_camara'] )) {
		...
		$hora_guardada  = $_GET['hora_guardada'];
		...
		try {
			...
			$q = 'INSERT INTO camera (id_camara, carros_entrantes, carros_salientes, hora_guardada) 
					values (:id_camara, :carros_entrantes, :carros_salientes, CURRENT_TIMESTAMP)';
...
$id_camara 		$carros_entrantes 		$carros_salientes		$hora_medida 